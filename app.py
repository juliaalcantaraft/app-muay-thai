...
st.markdown("""
## O que é o Muay Thai?
O **Muay Thai** é uma arte marcial tailandesa conhecida como a *Arte das 8 Armas*,
pois utiliza punhos, cotovelos, joelhos e canelas como armas de combate.
É um dos esportes mais completos e eficientes do mundo! 🌍
""")
...
golpe = st.selectbox("Escolha um golpe para saber mais:",
["Jab", "Teep (chute frontal)", "Roundhouse Kick", "Clinch com joelho"])
...
Attachments area
Preview YouTube video Os 10 nocautes mais BRUTAIS de Mike TysonPreview YouTube video Os 10 nocautes mais BRUTAIS de Mike Tyson
